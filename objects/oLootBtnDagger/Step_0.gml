...
if(distance_to_object(oLootPoint1)<15)
{
	 ...
	 GameManager.lootIndexSet1=12;
	 
	   if(instance_exists(oLoot1)){
	   oLoot1.image_index=1;
	   }
	   if(instance_exists(oLoot2)){
	   oLoot2.image_index=1;
	   }
	   if(instance_exists(oLoot3)){
	   oLoot3.image_index=1;
	   }
	   if(instance_exists(oLoot4)){
	   oLoot4.image_index=1;
	   }
	   if(instance_exists(oLoot5)){
	   oLoot5.image_index=1;
	   }
       
       destroyLootButtonIndex(0,1,0,0,false,true,false,false);
